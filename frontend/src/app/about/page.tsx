...
export const metadata: Metadata = {
    title: "About ConvertX – Free Online File Conversion Tools",
    description: "Learn about ConvertX, the free online file conversion platform with 40+ tools for PDF, image, audio and video — no signup, no watermarks.",
    ...
    return (
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
            ...
            <p style={{ fontSize: "1.125rem", color: "var(--color-text-secondary)", marginBottom: "2.5rem", lineHeight: 1.7 }}>
                ConvertX is a free, browser-based file conversion suite built for students, professionals, and everyday users who need fast, reliable file tools —
            ...
            <section style={{ marginBottom: "2.5rem" }}>
                ...
                <p style={{ lineHeight: 1.8, color: "var(--color-text-secondary)" }}>
                    We built ConvertX because we believe powerful file tools should be accessible to everyone — not just those who can afford expensive desktop software.
                    ...
                    ConvertX gives you the tools you need instantly, for free.
                </p>
            </section>
            ...
            <section style={{ marginBottom: "2.5rem" }}>
                ...
                <p style={{ lineHeight: 1.8, color: "var(--color-text-secondary)", marginBottom: "1rem" }}>
                    ConvertX offers 40+ free online tools across four major categories:
                </p>
            ...
            <section style={{ marginBottom: "2.5rem" }}>
                ...
                <p style={{ lineHeight: 1.8, color: "var(--color-text-secondary)" }}>
                    We take file privacy seriously. Every file you upload to ConvertX is automatically and permanently deleted from our servers within one hour of upload.
            ...
            <section style={{ marginBottom: "2.5rem" }}>
                <h2 style={{ fontSize: "1.375rem", fontWeight: 700, marginBottom: "0.75rem" }}>Who Uses ConvertX?</h2>
                <p style={{ lineHeight: 1.8, color: "var(--color-text-secondary)" }}>
                    Our users include:
                </p>
                <ul style={{ lineHeight: 2, color: "var(--color-text-secondary)", paddingLeft: "1.5rem" }}>
            ...
            <section style={{ marginBottom: "2.5rem" }}>
                ...
                <p style={{ lineHeight: 1.8, color: "var(--color-text-secondary)" }}>
                    ConvertX is, and will always be, free to use for the core conversion tools.
