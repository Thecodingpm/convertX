    ...
    return (
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
            ...
            <Section title="4. Cookies">
                <p>smartconvertx uses cookies for the following purposes:</p>
                <ul>
            ...
            <Section title="6. Children's Privacy">
                <p>
                    smartconvertx does not knowingly collect personal information from children under 13 years of age.
