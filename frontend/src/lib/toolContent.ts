...
const toolContent: Record<string, ToolContent> = {
    ...
    "pdf-to-word": {
        ...
        sections: [
            ...
            },
            {
                ...
                body: "Using ConvertX to convert your PDF to Word is quick and simple. First, visit this page and click the upload area or drag and drop your PDF file. The tool accepts any standard PDF file up to 50MB. Once your file appears in the upload area, click the 'Convert File' button. Our server will process your PDF immediately and extract all content with formatting preserved. When the conversion is complete (usually within a few seconds to a minute for large files), a download button will appear. Click it to save your new .docx file to your device. You can then open this file in any word processor.",
            },
            {
                heading: "Benefits of Using ConvertX for PDF to Word",
                body: "ConvertX offers several key advantages over other conversion tools. It is completely free to use — there is no subscription, no credit card required, and no hidden charges. You do not need to create an account to use any tool on our platform. Your privacy is protected: all uploaded files are permanently deleted from our servers within one hour. The converter works in any browser on any device, including smartphones and tablets — no software installation needed. Our conversion engine preserves the original formatting, including fonts, tables, images, and paragraph structure, giving you a cleaner, more accurate output than many competing tools.",
            },
        ],
        faqs: [
            { question: "Is the PDF to Word converter completely free?", answer: "Yes, ConvertX PDF to Word conversion is 100% free. There are no hidden charges, no subscription fees, and no limits on how many times you can use the tool. Simply upload your PDF and download the converted Word file." },
            ...
            { question: "Is it safe to upload my PDF to ConvertX?", answer: "Absolutely. All uploaded files are processed over a secure HTTPS connection and are permanently and automatically deleted from our servers within 1 hour of upload. We do not read, share, or retain your files." },
            ...
            { question: "Do I need to install any software?", answer: "No. ConvertX works entirely in your browser. There is nothing to download or install. It works on Windows, Mac, Linux, Android, and iOS devices." },
        ],
    ...
    "compress-pdf": {
        ...
        sections: [
            ...
            {
                heading: "How to Compress a PDF with ConvertX",
                body: "Compressing your PDF with ConvertX takes just a few clicks. Open the tool on this page, then drag and drop your PDF into the upload zone or click to browse your files. Once the file is uploaded, click 'Convert File' to start compression. Our server will optimise the PDF by reducing image resolution and stripping unnecessary data while preserving text clarity. When complete, download your compressed PDF. You can compare the original and compressed file sizes to see how much space you saved.",
            },
            {
                heading: "Benefits of Using ConvertX PDF Compressor",
                body: "Unlike desktop tools like Adobe Acrobat (which requires an expensive subscription), ConvertX is completely free. You get professional-grade compression in your browser without installing any software. Your files are processed on secure servers and automatically deleted after one hour. The tool works on all platforms including mobile — perfect for students compressing PDFs on their smartphones before submitting assignments on the go.",
            },
        ],
        faqs: [
    ...
    "merge-pdfs": {
        ...
        sections: [
            ...
            {
                heading: "How to Merge PDFs with ConvertX",
                body: "Merging PDFs with ConvertX is straightforward. Click the upload area or drag and drop all the PDF files you want to merge. You can add multiple PDFs at once. The files will be merged in the order they are uploaded, so arrange them carefully. After uploading all files, click 'Merge Files'. ConvertX will combine them into one PDF and notify you when the merged file is ready. Click the download button to save your combined PDF.",
            },
            {
            ...
            {
                heading: "Advantages of ConvertX PDF Merge",
                body: "ConvertX lets you merge unlimited PDFs in a single session — no per-merge charge, no credit system, no daily limits. Files are handled securely over HTTPS and are permanently deleted within one hour. Works perfectly on mobile devices, making it easy to combine PDFs stored in your phone's document folder before submitting forms online.",
            },
        ],
        faqs: [
    ...
    "split-pdf": {
        ...
        sections: [
            ...
            },
            {
                ...
                body: "Upload your PDF using the upload area on this page. Next, enter the 'From Page' and 'To Page' values — for example, enter 3 and 7 to extract pages 3 through 7. Then click 'Convert File'. ConvertX will extract the specified pages and create a new PDF containing only those pages. Download the resulting file when the conversion is complete.",
            },
            {
            ...
            {
                heading: "Why Choose ConvertX to Split PDFs",
                body: "ConvertX is the fastest way to split a PDF without installing software. The process takes under a minute for most documents and is completely free. Your original file is never permanently modified — the split creates a new document, leaving your original intact. All files are deleted from our servers within one hour, keeping your documents private.",
            },
        ],
        faqs: [
    ...
    "compress-image": {
        ...
        faqs: [
            ...
            { question: "What image formats does ConvertX support for compression?", answer: "We support JPG/JPEG, PNG, and WebP input formats. Output is in the same format as the original." },
    ...
    "resize-image": {
        ...
        sections: [
            ...
            {
                heading: "Why Use ConvertX to Resize Images",
                body: "Unlike Photoshop or other desktop software, ConvertX requires no installation, no learning curve, and no subscription. Students in rural areas with older computers can use ConvertX from any browser. The tool handles files up to 50MB and produces output in the same format as the input. All files are deleted within one hour — your personal photos remain private.",
            },
        ],
        faqs: [
            { question: "Can I resize an image to exact pixel dimensions?", answer: "Yes. Enter the exact width and height in pixels that you need. ConvertX will resize the image precisely to those dimensions." },
    ...
    "jpg-to-png": {
        ...
        sections: [
            ...
            {
                heading: "How to Convert JPG to PNG with ConvertX",
                body: "Converting your JPG to PNG using ConvertX is extremely simple. Open this page, click the upload area, and select your JPG or JPEG file. You can also drag and drop the file directly. Once uploaded, click 'Convert File'. The conversion is near-instant. Download the resulting PNG file. You now have the same image in PNG format, ready for use in editors, websites, or presentations.",
            },
            {
            ...
            {
                heading: "Benefits of ConvertX JPG to PNG",
        ...
        faqs: [
            ...
            { question: "Is ConvertX JPG to PNG free?", answer: "Yes, 100% free. No registration required, no limits, no watermarks on output." },
        ],
    ...
    "remove-background": {
        ...
        sections: [
            ...
            {
                heading: "Benefits of Using ConvertX Background Remover",
    ...
    "image-to-pdf": {
        ...
        sections: [
            ...
            {
                heading: "How to Convert Images to PDF with ConvertX",
            ...
            {
                heading: "Why ConvertX Is the Right Choice",
        ...
        faqs: [
            { question: "What image formats can I convert to PDF?", answer: "ConvertX supports JPG, JPEG, PNG, GIF, BMP, WebP, and TIFF image formats for conversion to PDF." },
            ...
            { question: "Can I use this on my phone?", answer: "Yes. ConvertX works in any mobile browser. Simply visit the page, upload your image from your phone's gallery, and download the converted PDF." },
        ],
    ...
    "extract-audio": {
        ...
        sections: [
            ...
            {
                heading: "How to Extract Audio from Video with ConvertX",
            ...
            {
                heading: "Why Use ConvertX for Audio Extraction",
                body: "ConvertX supports the most common video formats and outputs high-quality audio. The extraction process preserves the original audio quality from the video — no re-encoding quality loss when outputting to WAV. For MP3, a high-quality codec is used to maintain excellent auditory quality at a reasonable file size. The tool is free, works in-browser, and requires no software installation.",
            },
        ],
        faqs: [
            ...
            { question: "What video formats are supported?", answer: "ConvertX supports MP4, AVI, MKV, MOV, WMV, FLV, and WebM input video formats." },
    ...
    "compress-video": {
        ...
        sections: [
            ...
            {
                heading: "How to Compress a Video with ConvertX",
            ...
            {
                heading: "Advantages of ConvertX Video Compressor",
    ...
    "qr-code": {
        ...
        sections: [
            ...
            {
                heading: "Benefits of Using ConvertX QR Code Generator",
        ...
        faqs: [
            { question: "Are QR codes generated by ConvertX static or dynamic?", answer: "ConvertX generates static QR codes. This means the data (URL or text) is encoded directly in the QR code and cannot be changed after generation. For dynamic QR codes that can be updated, specialist services are required." },
            ...
            { question: "Will the QR code expire?", answer: "No. Static QR codes generated by ConvertX do not expire. They will work indefinitely as long as the URL you encoded remains active. If the URL changes or is deleted, the QR code will stop working." },
    ...
    "pdf-to-jpg": {
        ...
        sections: [
            ...
            {
                heading: "Advantages of ConvertX PDF to JPG",
        ...
        faqs: [
            ...
            { question: "How many pages can I convert at once?", answer: "ConvertX converts all pages in your uploaded PDF in one operation. Each page becomes a separate JPG file." },
    ...
    "video-to-gif": {
        ...
        sections: [
            ...
            {
                heading: "How to Convert Video to GIF with ConvertX",
            ...
            {
                heading: "Why Use ConvertX for GIF Creation",
